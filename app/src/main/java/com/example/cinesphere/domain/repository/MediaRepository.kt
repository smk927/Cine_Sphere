...
interface MediaRepository {
    ...
    suspend fun searchPerson(query: String): Int?
    suspend fun getPopularMedia(page: Int, mediaType: MediaType): List<Media>
    suspend fun getTrendingMedia(page: Int = 1): List<Media>
    suspend fun getUpcomingMovies(page: Int): List<Media>
    suspend fun getAnime(page: Int): List<Media>
    suspend fun getMoviesByGenre(genreId: Int): List<Media>
    suspend fun discoverMovies(genreIds: String?, castIds: String?, page: Int): List<Media>
    suspend fun discoverTv(genreIds: String?, castIds: String?, page: Int): List<Media>
